...
BEGIN
    ...
    INSERT INTO public.profiles (id, name, type, created_at)
    VALUES (
        new.id,
    ...
    -- 2. Initialize Wallet
    INSERT INTO public.wallet (profile_id, balance)
    VALUES (new.id, 0);

    -- 3. Initialize User Stats
    INSERT INTO public.user_stats (profile_id, total_completions, longest_streak, longest_single_habit_streak)
    VALUES (new.id, 0, 0, 0);
